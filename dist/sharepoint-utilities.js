...
var invoke = __webpack_require__(29);
...
var anObject = __webpack_require__(4);
var isObject = __webpack_require__(3);
var newPromiseCapability = __webpack_require__(13);
...
var global = __webpack_require__(0);
var macrotask = __webpack_require__(14).set;
...
var task = __webpack_require__(14).set;
var microtask = __webpack_require__(27)();
var newPromiseCapabilityModule = __webpack_require__(13);
var perform = __webpack_require__(26);
var promiseResolve = __webpack_require__(25);
var PROMISE = 'Promise';
...
// @@replace logic
__webpack_require__(19)('replace', 2, function (defined, REPLACE, $replace) {
...
// @@match logic
__webpack_require__(19)('match', 1, function (defined, MATCH, $match) {
...
var ClientObjectCollection = function () {
  ...
  ClientObjectCollection.prototype.forEach = function (iteratee) {
    ...
    while (enumerator.moveNext()) {
      if (iteratee(enumerator.get_current(), index++, this) === false) break;
    }
  };
  ...
  ClientObjectCollection.prototype.groupBy = function (iteratee) {
    return this.reduce(function (result, value) {
      ...
      if (Object.prototype.hasOwnProperty.call(result, key)) result[key].push(value);else result[key] = [value];
      return result;
    }, {});
  };
      ...
      case '[object Function]':
        {
          ...
          this.forEach(function (item, i) {
            if (filter_1(item, i, _this)) items_1.push(item);
          });
          return items_1;
        }
...
var getSodBaseAddress = function getSodBaseAddress() {
...
function registerSodDependency(sod, dep) {
  if (typeof dep === 'string') {
    ...
    dep.map(function (d) {
      return registerSodDependency(sod, d);
    });
  }
}
...
function importer(sod) {
  if (typeof sod === 'string') {
    var s_1 = sod.toLowerCase();
    return new Promise(function (resolve, reject) {
      if (!_v_dictSod[s_1] && s_1 !== 'sp.ribbon.js') {
        SP.SOD.registerSod(s_1, getSodBaseAddress() + s_1);

        for (var d = 0; sodDeps[s_1] && d < sodDeps[s_1].length; d++) {
          SP.SOD.registerSodDep(s_1, sodDeps[s_1][d]);
        }
      }
      ...
      SP.SOD.executeFunc(s_1, null, null);
    });
  }

  return Promise.all(sod.map(function (s) {
    return importSod(s);
  }));
}
...
function importSod(sod) {
  ...
  if (sod === 'sp.js' && !spjs_loaded) {
    return importer(sod).then(function () {
      spjs_loaded = true;
      registerExtensions();
    });
  }
...
function register(log) {
  return importSod('sp.js').then(function () {
    if (log) console.log('SharePoint extensions loaded.');
  });
}

exports.register = register;
var sharepointUtilities = {
  registerUnhandledErrorHandler: registerUnhandledErrorHandler,
  registerSodDependency: registerSodDependency,
  importSod: importSod,
  register: register
};
exports.default = sharepointUtilities;
